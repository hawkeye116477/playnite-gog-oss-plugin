...
## **Building**
To build this extension, for first you need to clone that repo with submodules. Then you need to install [meson](https://github.com/mesonbuild/meson/releases) and latest [Python 3.x](https://www.python.org/downloads/). If you already have everything needed, then you can use your favourite IDE like **Visual Studio 2019 Community** to build project. After you compile it, you can open `Playnite => Settings => For developers` and choose path where is dll located to load it or alternatively go to `make_scripts` directory and execute `make_extension.py` script with **Python** to make single .pext file which can be dropped to Playnite's window to install it.
PS: You can also do that without Python, but then would be more manual work.
...
## **Credits**
This project uses part of data from:
* https://gogapidocs.readthedocs.io/en/latest/galaxy.html
* https://github.com/Sude-/lgogdownloader
* https://github.com/Lariaa/GameLauncherResearch/wiki/GoG-:-Installing-games
