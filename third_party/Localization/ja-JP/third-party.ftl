...
third-party-playnite-configure = 設定
...
third-party-gog-login-checking = 認証ステータスを確認しています...
third-party-gog-logged-in = ユーザーは認証されています
third-party-gog-not-logged-in = 認証が必要です
third-party-gog-not-logged-in-error = ユーザー認証に失敗しました。
third-party-gog-authenticate-label = 認証
third-party-gog-trouble-shooting-issues = 問題のトラブルシューティング
third-party-gog-start-using-client = { $var0 } クライアントの使用を開始
third-party-gog-metadata-language-label = メタデータの言語
third-party-gog-settings-use-vertical-covers = 縦型カバーを使用
