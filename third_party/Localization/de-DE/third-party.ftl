...
third-party-playnite-working-dir-title = Arbeitsverzeichnis
...
third-party-playnite-configure = Konfigurieren
...
third-party-gog-settings-import-installed-label = Installierte Spiele importieren
third-party-gog-settings-import-uninstalled-label = Nicht installierte Spiele importieren
third-party-gog-settings-connect-account = Nutzerkonto verbinden
third-party-gog-login-checking = Authentifizierungsstatus wird überprüft …
third-party-gog-logged-in = Nutzer ist authentifiziert
third-party-gog-not-logged-in = Authentifizierung erforderlich
third-party-gog-not-logged-in-error = Nutzer konnte nicht authentifiziert werden.
third-party-gog-authenticate-label = Authentifizieren
third-party-gog-trouble-shooting-issues = Problembehebung
third-party-gog-start-using-client = Mit { $var0 }-Client starten
third-party-gog-metadata-language-label = Metadatensprache:
third-party-gog-settings-use-vertical-covers = Vertikale Cover verwenden
