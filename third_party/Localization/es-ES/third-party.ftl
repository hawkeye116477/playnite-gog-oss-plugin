...
third-party-gog-settings-import-installed-label = Importar juegos instalados
third-party-gog-settings-import-uninstalled-label = Importar juegos no instalados
third-party-gog-settings-connect-account = Conectar cuenta
third-party-gog-login-checking = Comprobando el estado de la autenticación…
third-party-gog-logged-in = El usuario está autenticado
third-party-gog-not-logged-in = Requiere autenticación
third-party-gog-not-logged-in-error = Fallo al autenticar usuario.
