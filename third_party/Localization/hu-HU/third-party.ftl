...
third-party-playnite-configure = Beállítás
...
third-party-gog-login-checking = Hitelesítés ellenőrzése…
third-party-gog-logged-in = Felhasználó hitelesítve
third-party-gog-not-logged-in = Felhasználói hitelesítés szükséges.
third-party-gog-not-logged-in-error = Felhasználói hitelesítés sikertelen.
third-party-gog-authenticate-label = Bejelentkezés
third-party-gog-trouble-shooting-issues = Hibaelhárítás
third-party-gog-start-using-client = { $var0 } használata
third-party-gog-metadata-language-label = Metaadat nyelve:
third-party-gog-settings-use-vertical-covers = Álló borítóképek használata
