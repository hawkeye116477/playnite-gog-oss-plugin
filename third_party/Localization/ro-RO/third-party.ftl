...
third-party-gog-settings-import-uninstalled-label = Importanți jocurile neinstalate
third-party-gog-settings-connect-account = Conectare cont
third-party-gog-login-checking = Se verifică starea de autentificare...
third-party-gog-logged-in = Utilizatorul este autentificat
third-party-gog-not-logged-in = Necesită autentificare
third-party-gog-not-logged-in-error = Autentificare eșuată.
third-party-gog-authenticate-label = Autentificați-vă
third-party-gog-trouble-shooting-issues = Probleme de depanare
third-party-gog-start-using-client = Începeți să folosiți clientul { $var0 }
third-party-gog-metadata-language-label = Limba metadatelor:
