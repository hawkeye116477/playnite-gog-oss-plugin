...
third-party-gog-settings-import-installed-label = Importar jocs instal·lats
third-party-gog-settings-import-uninstalled-label = Importar jocs no instal·lats
third-party-gog-settings-connect-account = Connectar compte
third-party-gog-login-checking = Comprovant estat d'autenticació...
third-party-gog-logged-in = L'usuari està autenticat
third-party-gog-not-logged-in = Requereix autenticació
third-party-gog-not-logged-in-error = No s’ha pogut autenticar l’usuari.
third-party-gog-authenticate-label = Autenticar
third-party-gog-trouble-shooting-issues = Resolució de problemes
third-party-gog-start-using-client = Iniciar a través del client { $var0 }
third-party-gog-metadata-language-label = Idioma de les metadades:
third-party-gog-settings-use-vertical-covers = Utilitzar portades verticals
