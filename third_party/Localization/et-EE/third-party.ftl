...
third-party-playnite-configure = Seadista
...
third-party-gog-settings-import-installed-label = Impordi paigaldatud mängud
third-party-gog-settings-import-uninstalled-label = Impordi paigaldamata mängud
third-party-gog-settings-connect-account = Ühenda konto
third-party-gog-login-checking = Autentimise oleku kontrollimine…
third-party-gog-logged-in = Kasutaja on autenditud
third-party-gog-not-logged-in = Vajalik on autentimine
third-party-gog-not-logged-in-error = Kasutaja autentimine ebaõnnestus.
third-party-gog-authenticate-label = Autendi
third-party-gog-trouble-shooting-issues = Probleemide tõrkeotsing
third-party-gog-start-using-client = Käivita klienti { $var0 } kasutades
third-party-gog-metadata-language-label = Metaandmete keel:
third-party-gog-settings-use-vertical-covers = Kasuta vertikaalsed kaanepiltid
