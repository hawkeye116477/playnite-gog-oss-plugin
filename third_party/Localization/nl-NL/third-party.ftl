...
third-party-playnite-configure = Configureer
...
third-party-gog-settings-import-installed-label = Importeer geïnstalleerde spellen
third-party-gog-settings-import-uninstalled-label = Importeer niet-geïnstalleerde spellen
third-party-gog-settings-connect-account = Accounts koppelen
third-party-gog-login-checking = Verificatiestatus aan het controleren...
third-party-gog-logged-in = De gebruiker is geverifieerd.
third-party-gog-not-logged-in = Verificatie vereist
third-party-gog-not-logged-in-error = Kan gebruiker niet verifiëren
third-party-gog-authenticate-label = Verifiëren
third-party-gog-trouble-shooting-issues = Probleemoplossing
third-party-gog-start-using-client = Starten met { $var0 } client
third-party-gog-metadata-language-label = Metadata taal:
third-party-gog-settings-use-vertical-covers = Gebruik verticale covers
