...
third-party-playnite-configure = 설정
...
third-party-gog-login-checking = 인증 상태 확인하는 중…
third-party-gog-logged-in = 사용자 인증됨
third-party-gog-not-logged-in = 인증이 필요함
third-party-gog-not-logged-in-error = 사용자 인증에 실패하였습니다.
third-party-gog-authenticate-label = 인증
third-party-gog-trouble-shooting-issues = 문제 해결
third-party-gog-start-using-client = { $var0 } 클라이언트 사용 시작
third-party-gog-metadata-language-label = 메타데이터 언어:
