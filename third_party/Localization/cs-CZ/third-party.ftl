...
third-party-playnite-configure = Konfigurovat
...
third-party-gog-login-checking = Ověřuji stav přihlášení…
third-party-gog-logged-in = Uživatel je přihlášen
third-party-gog-not-logged-in = Vyžaduje přihlášení
third-party-gog-not-logged-in-error = Přihlášení se nezdařilo.
third-party-gog-authenticate-label = Autentizovat
third-party-gog-trouble-shooting-issues = Řešení potíží
third-party-gog-start-using-client = Začít používat { $var0 } klienta.
third-party-gog-metadata-language-label = Jazyk metadat:
third-party-gog-settings-use-vertical-covers = Použít vertikální obálky
