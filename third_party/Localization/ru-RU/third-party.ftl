...
third-party-playnite-configure = Настроить
...
third-party-gog-settings-import-installed-label = Импортировать установленные игры
third-party-gog-settings-import-uninstalled-label = Импортировать неустановленные игры
third-party-gog-settings-connect-account = Подключить аккаунт
third-party-gog-login-checking = Проверка статуса аутентификации…
third-party-gog-logged-in = Пользователь авторизован
third-party-gog-not-logged-in = Требуется авторизация
third-party-gog-not-logged-in-error = Не удалось авторизовать пользователя.
third-party-gog-authenticate-label = Аутентификация
third-party-gog-trouble-shooting-issues = Устранение неполадок
third-party-gog-start-using-client = Запустить через клиент { $var0 }
third-party-gog-metadata-language-label = Язык метаданных:
third-party-gog-settings-use-vertical-covers = Использовать вертикальные обложки
