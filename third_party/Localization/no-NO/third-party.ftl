...
third-party-playnite-configure = Konfigurer
...
third-party-gog-login-checking = Kontrollerer autentiseringsstatus …
third-party-gog-logged-in = Brukeren er autentisert
third-party-gog-not-logged-in = Krever autentisering
third-party-gog-not-logged-in-error = Brukerautentisering mislyktes.
third-party-gog-authenticate-label = Autentiser
third-party-gog-trouble-shooting-issues = Feilsøking av problemer
third-party-gog-start-using-client = Begynn å bruke { $var0 }-klient
third-party-gog-metadata-language-label = Språk for metadata:
third-party-gog-settings-use-vertical-covers = Bruk vertikale omslag
