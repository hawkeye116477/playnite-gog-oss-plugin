...
third-party-playnite-working-dir-title = Working Directory
...
third-party-playnite-configure = Configure
...
third-party-gog-settings-import-installed-label = Import installed games
third-party-gog-settings-import-uninstalled-label = Import not installed games
third-party-gog-settings-connect-account = Connect account
third-party-gog-login-checking = Checking authentication status…
third-party-gog-logged-in = User is authenticated
third-party-gog-not-logged-in = Requires authentication
third-party-gog-not-logged-in-error = Failed to authenticate user.
third-party-gog-authenticate-label = Authenticate
third-party-gog-trouble-shooting-issues = Troubleshooting issues
third-party-gog-start-using-client = Start using { $var0 } client
third-party-gog-metadata-language-label = Metadata language:
third-party-gog-settings-use-vertical-covers = Use vertical covers
