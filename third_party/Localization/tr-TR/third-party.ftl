...
third-party-playnite-configure = Yapılandır
...
third-party-gog-login-checking = Kimlik doğrulama durumu kontrol ediliyor…
third-party-gog-logged-in = Kullanıcı kimliği doğrulandı
third-party-gog-not-logged-in = Kimlik doğrulaması gerektiriyor
third-party-gog-not-logged-in-error = Kullanıcı kimliği doğrulanamadı.
third-party-gog-authenticate-label = Kimlik Doğrulaması
third-party-gog-trouble-shooting-issues = Sorunları giderme
third-party-gog-start-using-client = { $var0 } istemcisini kullanarak başlat
third-party-gog-metadata-language-label = Üst veri dili:
third-party-gog-settings-use-vertical-covers = Dikey kapaklar kullan
