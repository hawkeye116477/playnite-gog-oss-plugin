...
third-party-gog-settings-import-uninstalled-label = Importuoti neįdiegtus žaidimus
third-party-gog-settings-connect-account = Susieti paskyrą
third-party-gog-login-checking = Tikrinama autentifikavimo būsena...
third-party-gog-logged-in = Vartotojas autentifikuotas
third-party-gog-not-logged-in = Reikalinga autentifikavimas
third-party-gog-not-logged-in-error = Nepavyko autentifikuoti vartotojo.
third-party-gog-authenticate-label = Autentifikuoti
third-party-gog-trouble-shooting-issues = Tvarkoma klaidas
third-party-gog-start-using-client = Pradėti naudojant { $var0 } klientą
third-party-gog-metadata-language-label = Metadata kalba:
