...
third-party-playnite-working-dir-title = Répertoire de travail
...
third-party-playnite-configure = Configurer
...
third-party-gog-settings-import-installed-label = Importer les jeux installés
third-party-gog-settings-import-uninstalled-label = Importer les jeux non installés
third-party-gog-settings-connect-account = Connecter un compte
third-party-gog-login-checking = Vérification…
third-party-gog-logged-in = Statut : Utilisateur connecté
third-party-gog-not-logged-in = Statut : Authentification requise
third-party-gog-not-logged-in-error = Impossible de connecter l'utilisateur.
third-party-gog-authenticate-label = Connexion
third-party-gog-trouble-shooting-issues = Résolution des problèmes
third-party-gog-start-using-client = Lancer avec le client { $var0 }
third-party-gog-metadata-language-label = Langue des métadonnées :
third-party-gog-settings-use-vertical-covers = Utiliser des couvertures verticales
