...
third-party-playnite-configure = Konfigurasi
...
third-party-gog-login-checking = Mengecek status autentikasi…
third-party-gog-logged-in = Pengguna terautentikasi
third-party-gog-not-logged-in = Memerlukan autentikasi
third-party-gog-not-logged-in-error = Gagal mengautentikasi pengguna
third-party-gog-authenticate-label = Autentikasi
third-party-gog-trouble-shooting-issues = Memecahkan masalah
third-party-gog-start-using-client = Mulai menggunakan klien { $var0 }
third-party-gog-metadata-language-label = Bahasa metadata:
