...
third-party-playnite-working-dir-title = Directorio de traballo
...
third-party-playnite-configure = Configurar
...
third-party-gog-settings-import-installed-label = Importar xogos instalados
third-party-gog-settings-import-uninstalled-label = Importar xogos non instalados
third-party-gog-settings-connect-account = Vincular conta
third-party-gog-login-checking = Comprobando estado da verificación
third-party-gog-logged-in = O usuario xa está verificado
third-party-gog-not-logged-in = Requírese verificación
third-party-gog-not-logged-in-error = Erro na verificación do usuario
third-party-gog-authenticate-label = Verificar
third-party-gog-trouble-shooting-issues = Solución de problemas
third-party-gog-start-using-client = Comezar usando o cliente { $var0 }
third-party-gog-metadata-language-label = Idioma dos metadatos:
