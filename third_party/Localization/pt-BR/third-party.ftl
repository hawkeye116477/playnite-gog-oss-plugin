...
third-party-gog-login-checking = Verificando o estado da autenticação…
third-party-gog-logged-in = Usuário autenticado
third-party-gog-not-logged-in = Requer autenticação
third-party-gog-not-logged-in-error = Falha ao autenticar o usuário.
third-party-gog-authenticate-label = Autenticar
third-party-gog-trouble-shooting-issues = Soluções de problemas
third-party-gog-start-using-client = Começar usando cliente { $var0 }
third-party-gog-metadata-language-label = Idioma dos metadados:
third-party-gog-settings-use-vertical-covers = Usar capas verticais
