...
third-party-playnite-configure = הגדר
...
third-party-gog-login-checking = בודק מצב אימות…
third-party-gog-logged-in = המשתמש מאומת
third-party-gog-not-logged-in = מחייב אימות
third-party-gog-not-logged-in-error = נכשל באימות משתמש.
third-party-gog-authenticate-label = אימות
third-party-gog-trouble-shooting-issues = פתרון בעיות
third-party-gog-start-using-client = התחל להשתמש בלקוח { $var0 }
third-party-gog-metadata-language-label = שפת מטא-נתונים:
third-party-gog-settings-use-vertical-covers = השתמש בתמונה של Steam
