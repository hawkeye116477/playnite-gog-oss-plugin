...
third-party-playnite-configure = Đặt lại cấu hình
...
third-party-gog-not-logged-in = Yêu cầu xác thực
third-party-gog-not-logged-in-error = Không xác thực được người dùng.
third-party-gog-authenticate-label = Xác thực
