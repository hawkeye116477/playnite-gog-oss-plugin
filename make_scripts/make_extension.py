...
extFile = pj(mainPath, "Releases", "GogOssLibrary_" +
...
if os.path.exists(extFile):
    ...
    if newVersion == "true":
        installerManifest["Packages"].insert(0, {
            ...
            "PackageUrl": f"https://github.com/hawkeye116477/playnite-gog-oss-plugin/releases/download/{version}/GogOssLibrary_{versionUnderline}.pext",
